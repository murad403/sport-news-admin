        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full p-3 bg-slate-950 border border-slate-800 focus:ring-1 focus:ring-rose-500/30 focus:border-rose-500/50 rounded-xl text-xs text-slate-200 placeholder-slate-600 outline-none transition-all resize-none"
              required
            />
          </div>
