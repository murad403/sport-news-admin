        ...
        <div className="lg:col-span-2 space-y-5 p-6 rounded-2xl bg-slate-900/40 backdrop-blur-md border border-slate-800/80 shadow-lg">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-slate-950/50 focus:bg-slate-950 border ${errors.title ? "border-rose-500/50 focus:ring-rose-500/20" : "border-slate-800 focus:ring-indigo-500/50"
                } focus:ring-1 rounded-lg text-sm text-slate-100 placeholder-slate-500 outline-none transition-all`}
            />
            {errors.title && (
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 bg-slate-950/50 focus:bg-slate-950 border border-slate-800 focus:ring-1 focus:ring-indigo-500/50 rounded-lg text-xs text-slate-200 placeholder-slate-600 outline-none transition-all resize-none"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className={`w-full p-4 bg-slate-950/50 focus:bg-slate-950 border ${errors.content ? "border-rose-500/50 focus:ring-rose-500/20" : "border-slate-800 focus:ring-indigo-500/50"
                } focus:ring-1 rounded-lg text-xs text-slate-200 placeholder-slate-600 outline-none resize-none no-scrollbar`}
            />
            {errors.content && (
              <p className="text-[10px] text-rose-400 font-semibold flex items-center gap-1 mt-1">
                <AlertCircle className="w-3 h-3" />
          ...
          <div className="p-6 rounded-2xl bg-slate-900/40 backdrop-blur-md border border-slate-800/80 shadow-lg space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full px-3 py-2.5 bg-slate-950 border border-slate-850 rounded-lg text-xs text-slate-200 outline-none transition-all cursor-pointer"
              >
