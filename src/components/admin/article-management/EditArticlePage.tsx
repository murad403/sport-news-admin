...
export default function EditArticlePage() {
  ...
  const { data: article, isLoading: isDetailsLoading } = useGetArticleDetailsQuery(articleSlug || "", {
    skip: !articleSlug,
  });
  ...
  if (isDetailsLoading) {
    return (
      <div className="py-24 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-xs text-slate-400 font-medium mt-3">Loading article...</p>
      </div>
    );
  }
