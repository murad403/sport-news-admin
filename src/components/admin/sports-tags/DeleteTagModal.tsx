    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-6 z-10 animate-in zoom-in-95 duration-200 text-center">
        ...
        <p className="text-xs text-slate-400 mt-2 leading-relaxed">
          Are you sure you want to delete the tag <span className="font-semibold text-slate-200">"{tagName}"</span>? This will permanently remove it from the platform. Articles associated with this tag may require updates.
        </p>
